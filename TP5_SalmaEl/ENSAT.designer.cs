...
namespace TP5_SalmaEl
{
    ...
    partial void Deletenotes2021(notes2021 instance);
		...
		public System.Data.Linq.Table<notes2021> notes2021s
		{
			get
			{
	...
	public partial class eleves : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<notes2021> _notes2021s;
    ...
    partial void OnniveauChanged();
		...
		public eleves()
		{
			...
			this._notes2021s = new EntitySet<notes2021>(new Action<notes2021>(this.attach_notes2021s), new Action<notes2021>(this.detach_notes2021s));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="eleves_notes2021", Storage="_notes2021s", ThisKey="codeElev", OtherKey="codeElev")]
		public EntitySet<notes2021> notes2021s
		{
			get
			{
				return this._notes2021s;
			}
			set
			{
				this._notes2021s.Assign(value);
			}
		}
		...
		private void attach_notes2021s(notes2021 entity)
		{
			this.SendPropertyChanging();
			entity.eleves = this;
		}
		
		private void detach_notes2021s(notes2021 entity)
		{
			this.SendPropertyChanging();
			entity.eleves = null;
		}
    ...
    partial void OnRespMatChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="matieres_notes2021", Storage="_notes2021s", ThisKey="codeMat", OtherKey="codeMat")]
		public EntitySet<notes2021> notes2021s
		{
			get
			{
    ...
    partial void OnidChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_codeElev", DbType="NVarChar(20) NOT NULL", CanBeNull=false)]
		public string codeElev
		{
			get
			{
		...
		public eleves eleves
		{
			...
			set
			{
							...
							|| (this._eleves.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._eleves.Entity = null;
						previousValue.notes2021s.Remove(this);
					}
					this._eleves.Entity = value;
					if ((value != null))
					{
						value.notes2021s.Add(this);
						this._codeElev = value.codeElev;
					}
					else
					{
